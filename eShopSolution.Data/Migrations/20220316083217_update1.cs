        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OrderDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2022, 3, 16, 15, 32, 16, 550, DateTimeKind.Local).AddTicks(2528)),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "30ac03a2-e9ff-42d1-bb82-14507e561f96", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "ca945a9c-1e65-4840-9c05-b46ec9986a68", new DateTime(1998, 3, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.international@gmail.com", true, "Minh", "Thang", false, null, "tedu.international@gmail.com", "thang", "AQAAAAEAACcQAAAAEGUe13JFEGJV6U4cxe/Lhrvm2+hZ0Tew03IMSgxpU/T6J1rLL0HEFSH51pqcf691NA==", null, false, "", false, "thang" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 3, 16, 15, 32, 16, 562, DateTimeKind.Local).AddTicks(3342), 100000m, 200000m });
